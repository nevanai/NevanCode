...
export const INPUT_MODE_CONFIGS: Record<InputMode, InputModeConfig> = {
  ...
  ultraReview: {
    ...
    label: 'UltraReview',
    color: 'info',
    placeholder: 'describe what to deeply review...',
    widthAdjustment: 14, // ` UltraReview ` label width + padding
    showAgentModeToggle: false,
    disableSlashSuggestions: true,
    blockKeyboardExit: false,
  },
  ...
  'connect:claude': {
    ...
    label: null,
    color: 'info',
    placeholder: 'paste the Claude authorization code and press Enter...',
    widthAdjustment: 3,
    showAgentModeToggle: false,
    disableSlashSuggestions: true,
    blockKeyboardExit: false,
  ...
  'connect:gemini': {
    ...
    label: null,
    color: 'info',
    placeholder: 'paste the Gemini authorization code and press Enter...',
    widthAdjustment: 3,
    showAgentModeToggle: false,
    disableSlashSuggestions: true,
    blockKeyboardExit: false,
