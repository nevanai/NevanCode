...
/**
 * Get the accent color for the logo. Black & white only:
 * dark mode → white, light mode → black. Matches the block color so the
 * logo renders as a single monochrome shape.
 */
...
// Pure black & white palette: only neutrals, no chromatic accents.
const DEFAULT_CHAT_THEMES: Record<ThemeName, ChatTheme> = {
  dark: {
    name: 'dark',
    // Core semantic colors — all white/gray neutrals
    primary: '#ffffff',
    secondary: '#bfbfbf',
    success: '#ffffff',
    error: '#ffffff',
    ...
    // Agent backgrounds — black/gray scale only
    agentToggleHeaderBg: '#1a1a1a',
    agentToggleExpandedBg: '#262626',
    agentFocusedBg: '#2a2a2a',
    agentContentBg: '#000000',
    inputFg: '#ffffff',
    inputFocusedFg: '#ffffff',

    // Mode toggles — all monochrome
    modeFastBg: '#ffffff',
    modeFastText: '#ffffff',
    modeMaxBg: '#ffffff',
    modeMaxText: '#ffffff',
  ...
  light: {
    name: 'light',
    // Core semantic colors — all black/gray neutrals
    primary: '#000000',
    secondary: '#4a4a4a',
    success: '#000000',
    error: '#000000',
    ...
    // Agent context
    agentToggleHeaderBg: '#e0e0e0',
    agentToggleExpandedBg: '#d0d0d0',
    agentFocusedBg: '#f0f0f0',
    ...
    markdown: {
      ...
      listBulletFg: '#4a4a4a',
      blockquoteBorderFg: '#bfbfbf',
      blockquoteTextFg: '#000000',
      dividerFg: '#d0d0d0',
      codeMonochrome: true,
    },
  },
