...
/** Increments each time skills are reloaded, used to invalidate React memos */
let skillsVersion = 0
...
/**
 * Get the current skills version counter. Increments on each reload.
 * Use as a React dependency to re-derive skills after plugin install/uninstall.
 */
