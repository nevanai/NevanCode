...
export const getCliEnv = (): CliEnv => ({
  ...
  NEVAN_SEMANTIC_CONTEXT: process.env.NEVAN_SEMANTIC_CONTEXT,
  NEVAN_CONTEXT_INJECTION: process.env.NEVAN_CONTEXT_INJECTION,
  NEVAN_CURATION_THRESHOLD: process.env.NEVAN_CURATION_THRESHOLD,
