      ...
      <box style={{ flexDirection: 'column' }}>
        ...
        <box style={{ flexDirection: 'row', alignItems: 'center' }}>
          ...
          <text style={{ flexShrink: 0, wrapMode: 'none' }}>
            {/* Added section: lighter gray bar with +N inside */}
            <span fg={theme.foreground} bg="#4a4a4a">
              {addedContent}
            </span>
            {/* Removed section: darker gray bar with -N inside */}
            <span fg={theme.foreground} bg="#2a2a2a">
              {removedContent}
            </span>
          </text>
        </box>
