...
// Long default so context7 lookups never abort a long-running agent session.
// Override with CONTEXT7_TIMEOUT_MS or disable via CODEBUFF_DISABLE_TIMEOUTS=1.
const FETCH_TIMEOUT_MS = (() => {
  const envValue =
    typeof process !== 'undefined'
      ? process.env?.CONTEXT7_TIMEOUT_MS
      : undefined
